...
Importing this package automatically registers all built-in chat integrations
into the bot registry. Call ``bot.registry.create_bot(settings)``
...
registry.register("time", TimeBotIntegration)
